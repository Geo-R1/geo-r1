...
RUN_NAME = "Qwen2.5-VL-3B-Instruct-rec-vrsb-grounding-train260"
MODEL_PATH = f"/training/Anonymous/VLM-R1/checkpoints/rl/{RUN_NAME}/checkpoint-{steps}"
OUTPUT_PATH="./logs_260_dapo/rec_results_{DATASET}_{RUN_NAME}_{STEPS}_dapo.json"
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=8 test_rec_r1.py
